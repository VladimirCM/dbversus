...
async function resumenesContarOrdenesScylladb(): Promise<number> {
  ...
  await $fetch("/api/scylladb/resumenes/countordenes", {
    method: "GET",
    headers: {
...
async function resumenesProductosScylladb(): Promise<number> {
  let start = new Date().getTime()
  await $fetch("/api/scylladb/resumenes/productosdiarios", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
async function resumenesProductosFechaScylladb(): Promise<number> {
  ...
  await $fetch("/api/scylladb/resumenes/productosdiariosfecha?fecha=" + fecha, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
async function resumenesTotalDiarioScylladb(): Promise<number> {
  let start = new Date().getTime()
  await $fetch("/api/scylladb/resumenes/totaldiario", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
...
async function resumenesToptenScylladb(): Promise<number> {
  let start = new Date().getTime()
  await $fetch("/api/scylladb/resumenes/topten", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
    },
